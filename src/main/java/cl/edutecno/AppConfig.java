...
@Configuration//anotción identificando que es una clase de configuración
@ComponentScan("cl.edutecno")//escaneo del paquete que contiene la clase de configuración
